...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-black text-neutral-900 dark:text-neutral-100 font-sans selection:bg-neutral-200 dark:selection:bg-neutral-800 transition-colors duration-300">
      ...
      {/* Top Banner */}
      <AnimatePresence>
        <div className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 px-4 py-2 text-[11px] sm:text-[13px] font-medium text-center relative z-50 leading-snug">
          {appLanguage === 'fr' ? (
            <>
              Vous souhaitez ajouter une API ? Contactez le développeur : <a href="https://www.linkedin.com/in/amine-nahli-48b2a734b/" className="underline hover:text-neutral-300 dark:hover:text-neutral-600 transition-colors" target="_blank" rel="noreferrer">LinkedIn</a> • <a href="mailto:nahli-ami@upf.ac.ma" className="underline hover:text-neutral-300 dark:hover:text-neutral-600 transition-colors">Email</a>
            </>
          ) : (
            <>
              Want to submit an API? Contact the developer: <a href="https://www.linkedin.com/in/amine-nahli-48b2a734b/" className="underline hover:text-neutral-300 dark:hover:text-neutral-600 transition-colors" target="_blank" rel="noreferrer">LinkedIn</a> • <a href="mailto:nahli-ami@upf.ac.ma" className="underline hover:text-neutral-300 dark:hover:text-neutral-600 transition-colors">Email</a>
            </>
          )}
        </div>
      </AnimatePresence>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 py-4 mb-8 border-b border-neutral-200 dark:border-neutral-900">
          <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
            ...
            <select className="appearance-none bg-white dark:bg-[#0a0a0a] text-neutral-700 dark:text-neutral-300 text-[13px] font-medium px-3 py-1.5 rounded-md border border-neutral-200 dark:border-neutral-800 focus:outline-none hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors cursor-pointer" value={auth} onChange={e => setAuth(e.target.value)}>
              ...
              <option value="Yes">Auth: Req</option>
            </select>
